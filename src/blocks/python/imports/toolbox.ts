const toolbox = `<xml>
<category name="Imports" colour="#ff0066" iconclass="blocklyTreeIconCustom imports">

  <label text="Imports" web-class="toolboxLabel"></label>
  ...
  <block type="import_mlimages"></block>
  <block type="import_imagedata"></block>
