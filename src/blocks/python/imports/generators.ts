...
Blockly.Python["import_mlimages"] = function() {
  const code = "from mlimages import *\n";
  return code;
};

Blockly.Python["import_imagedata"] = function() {
...
Blockly.Python["import_signal"] = function() {
  const code = "from signal import pause\n";
  return code;
};

Blockly.Python["import_pygal"] = function() {
  const code = "import pygal\n";
  return code;
};

Blockly.Python["import_processing"] = function() {
  const code = "from processing import *\n";
  return code;
};

Blockly.Python["pause_s"] = function() {
  const code = "pause()\n";
  return code;
};

Blockly.Python["random"] = function() {
...
Blockly.Python["class"] = function(block) {
  const text_const = Blockly.Python.valueToCode(
    block,
    "class",
...
Blockly.Python["for"] = function(block) {
  let branch = Blockly.Python.statementToCode(block, "DO");
  branch = Blockly.Python.addLoopTrap(branch, block.id) || Blockly.Python.PASS;
  const text_letter = Blockly.Python.valueToCode(
    block,
    "letter",
    Blockly.Python.ORDER_ATOMIC
  );
  const text_no = Blockly.Python.valueToCode(
    block,
    "no",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["advancedforloops"] = function(block) {
  let branch = Blockly.Python.statementToCode(block, "DO");
  branch = Blockly.Python.addLoopTrap(branch, block.id) || Blockly.Python.PASS;
  const text_x = Blockly.Python.valueToCode(
    block,
    "x",
    Blockly.Python.ORDER_ATOMIC
  );
  const text_y = Blockly.Python.valueToCode(
    block,
    "y",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["importinputs"] = function() {
  // TODO: Assemble Python into code variable.
...
Blockly.Python["return2"] = function(block) {
  const text_return = Blockly.Python.valueToCode(
    block,
    "return",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["df"] = function(block) {
  const text_def = Blockly.Python.valueToCode(
    block,
    "def",
    Blockly.Python.ORDER_ATOMIC
  );
  const text_params = Blockly.Python.valueToCode(
    block,
    "params",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["whileout"] = function(block) {
  const text_1 = Blockly.Python.valueToCode(
    block,
    "cond",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["import_audio"] = function() {
...
Blockly.Python["print"] = function(block) {
  const text_print = Blockly.Python.valueToCode(
    block,
    "print",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["equalsblocknew"] = function(block) {
  const value_text1 = Blockly.Python.valueToCode(
    block,
    "text1",
    Blockly.Python.ORDER_ATOMIC
  );
  const value_text2 = Blockly.Python.valueToCode(
    block,
    "text2",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["define"] = function(block) {
  ...
  const text_2 = Blockly.Python.valueToCode(
    block,
    "2",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["ifinline"] = function(block) {
  ...
  branch = Blockly.Python.addLoopTrap(branch, block.id) || Blockly.Python.PASS;
  const value_iftext = Blockly.Python.valueToCode(
    block,
    "iftext",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["typeanything"] = function(block) {
  const text_stuff = Blockly.Python.valueToCode(
    block,
    "stuff",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["internal"] = function(block) {
  const value_first = Blockly.Python.valueToCode(
    block,
    "first",
    Blockly.Python.ORDER_ATOMIC
  );
  const text_choose = block.getFieldValue("choose");
  const value_last = Blockly.Python.valueToCode(
    block,
    "last",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["not"] = function(block) {
  const value_bool = Blockly.Python.valueToCode(
    block,
    "bool",
    Blockly.Python.ORDER_ATOMIC
  );
...
Blockly.Python["varinlines"] = function(block) {
  const variable_name = Blockly.Python.variableDB_.getName(
